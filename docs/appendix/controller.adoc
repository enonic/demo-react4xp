...
[source,YAML]
----
include::../../src/main/resources/cms/site.yaml[]
----
...
On Enonic XP 8, mounting the `react4xp` and `asset` APIs is required wherever React4XP renders - see <<api#mount-api, Mount the API>>.
