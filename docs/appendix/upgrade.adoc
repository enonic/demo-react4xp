...
This describes upgrading from R4XP 6.x to R4XP 7, which introduces compatibility with XP8.
...
. On Enonic XP 8, <<library#mount-api, mount the React4XP API>> in each descriptor that renders React4XP (site, admin tool, webapp).
