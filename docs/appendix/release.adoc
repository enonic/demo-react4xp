...
The latter is a breaking change. However, React4XP is still able to render multiple entries on a page (i.e. only render your parts with React4XP) if needed. Check out the xref:legacy-upgrade.adoc# [legacy mode upgrade].
...
To migrate a legacy React4XP application we have written detailed xref:upgrade.adoc# [upgrade notes].
