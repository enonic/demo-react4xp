...
1. is located in a folder below one of the *entryDirs* folders listed in _react4xp.config.js_ - the starter uses *_react4xp/entries/_* (see also <<jsxpath#, jsxPath>>).
