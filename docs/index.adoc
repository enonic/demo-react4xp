...
image:r4xp-demo.png[title="React4xp front-end rendering the Headless Movie DB",900px]
...
== Dive deeper
Beyond the tutorial, visit the link:https://developer.enonic.com/docs/react4xp/6.x[React4XP reference].
