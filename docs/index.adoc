...
React4XP is designed for React devs looking to use Enonic's JS framework natively, rather than introducing a 3rd party front-end framework like https://developer.enonic.com/learn/next.xp[Next.js] in the stack.
...
image:r4xp-demo.png[title="React4xp front-end rendering content from the Headless Movie DB",1620px]
...
== Dive deeper
Beyond the tutorial, the link:https://developer.enonic.com/docs/react4xp[React4XP reference documentation] covers the library API, SSR and hydration, build and configuration in depth.
