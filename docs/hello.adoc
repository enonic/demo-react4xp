...
TIP: Dive deeper by learning how the basic boot-strapping and routing works in the link:https://developer.enonic.com/docs/react4xp/app[app controller documentation].
