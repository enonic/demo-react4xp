...
The component was initially rendered on the server, then link:https://developer.enonic.com/docs/react4xp/hydration[hydrated] to spin up as a client-side React component.
...
TIP: Dive deeper by learning how the basic boot-strapping and routing works in the link:https://developer.enonic.com/docs/react4xp/controller[app controller documentation].
