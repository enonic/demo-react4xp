...
Enonic boasts a https://developer.enonic.com/docs/cms/stable/schemas/form-items/htmlarea[rich text form item].
...
image::rich-text-bio.png[title="Rich text bio field for Lea Seydoux",width=969px]
...
----
+
NOTE: The link:https://developer.enonic.com/docs/react4xp/stable/library#processhtml[processHtml] function from `lib-react4xp` transforms raw data into a format that the `RichText` component can use.
