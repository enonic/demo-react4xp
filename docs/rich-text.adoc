...
----
+
NOTE: The link:https://developer.enonic.com/docs/react4xp/library#processhtml[processHtml] function from `lib-react4xp` transforms raw data into a format that the `RichText` component can use.
